...
<html>
	<head>
		<title>Qui me suit? <?php echo $profileData->screenName. ' (@'.$profileData->username.')';?></title>
		<meta charset="UTF-8" />
				...
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							...
							<li><a href="<?php echo BASE_URL;?>settings/account">Paramettre</a></li>
	...
	<ul>
		...
		<li>
			<a href="<?php echo BASE_URL.$profileData->username;?>/following">
				<div class="n-head">
					<a href="<?php echo BASE_URL.$profileData->username;?>/following">SUIVRE</a>
				</div>
				<div class="n-bottom">
