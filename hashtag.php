...
<html>
	<head>
		<title>#<?php echo $hashtag;?> Hashtag sur Univers</title>
		<meta charset="UTF-8" />
				...
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							...
							<li><a href="<?php echo BASE_URL;?>settings/account">Paramettres</a></li>
							<li><a href="<?php echo BASE_URL;?>includes/logout.php">Deconnexion</a></li>
						</ul>
					</div>
				</div>
				</li>
...
<div class="hash-menu">
	<div class="hash-menu-inner">
		<ul>
 			<li><a href="<?php echo BASE_URL.'hashtag/'.$hashtag;?>">plus nouveau</a></li>
			<li><a href="<?php echo BASE_URL.'hashtag/'.$hashtag.'?f=users';?>">Paramettres</a></li>
