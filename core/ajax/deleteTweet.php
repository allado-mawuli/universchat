  ...
  <div class="wrap5">
    <div class="retweet-popup-body-wrap">
      <div class="retweet-popup-heading">
        <h3>Etes-vous sur de vouloir supprimer ce Tweet?</h3>
      ...
      <div class="retweet-popup-footer">
        <div class="retweet-popup-footer-right">
          <button class="cancel-it f-btn">Annulez</button><button class="delete-it" data-tweet="<?php echo $tweet->tweetID;?>" type="submit">Supprimez</button>
        </div>
      </div>
    </div>
  </div>
