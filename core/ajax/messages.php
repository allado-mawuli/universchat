			...
			<div class="message-send2">
				...
				<div class="message-del">
					<div class="message-del-inner">
						<h4>Etes-vous sur de vouloir supprimer ce message? </h4>
						<div class="message-del-box">
							<span>
								<button class="cancel" value="Cancel">Annulez</button>
							</span>
							<span>
								<button class="delete" value="Delete">Supprimez</button>
							</span>
						</div>
					</div>
				</div>
