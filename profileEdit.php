...
<html>
<head>
	<title>Editer le profil - Univers</title>
	<meta charset="UTF-8" />
				...
				<div class="drop-wrap">
					<div class="drop-inner">
						<ul>
							...
							<li><a href="settings/account">Paramettres</a></li>
		...
		<div class="img-upload-button-wrap">
			<div class="img-upload-button1">
				...
				<span class="span-text1">
					Changez votre photo de profile 
				</span>
