    ...
    <?php if ($_GET['step'] == '2'){?>
  	<div class='lets-wrapper'>
  		<div class='step-letsgo'>
  			<h2>Nous sommes heureux que vous soyez ici, <?php echo $user->screenName; ?> </h2>
  			<p>Univers est un flux constamment mis à jour des nouvelles,de l'Universite, des médias, des sports, de la télévision, des conversations intra personnelle.</p>
  			<br/>
  			<p>
  				Parlez-nous de tout ce que vous aimez et nous vous aiderons à vous installer.
  			</p>
  			<span>
  				<a href='../home.php' class='backButton'>Commencons!</a>
  			</span>
  		</div>
  	</div>
  <?php } ?>
